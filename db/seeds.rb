...
Prefecture.create(id: 3, name: '秋田県')
Prefecture.create(id: 4, name: '岩手県')
Prefecture.create(id: 5, name: '宮城県')
Prefecture.create(id: 6, name: '山形県')
Prefecture.create(id: 7, name: '福島県')
Prefecture.create(id: 8, name: '栃木県')
Prefecture.create(id: 9, name: '茨城県')
...
Prefecture.create(id: 48, name: '未設定')